    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,   "/api/admin/scenarios/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET,    "/api/admin/scenarios/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,    "/api/admin/scenarios/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/admin/scenarios/**").hasRole("ADMIN")
